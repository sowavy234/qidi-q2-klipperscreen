...
class AuthTests(unittest.TestCase):
    def test_pairing_identity_and_sensitive_challenge_are_required(self):
        ...
        self.assertTrue(auth.authorize("q2-abc", "purge", challenge))
    ...
    def test_expiry_replay_and_printer_mismatch_are_rejected(self):
        ...
        self.assertFalse(auth.authorize("other", "pause", challenge))
        now[0] = 9
        self.assertFalse(auth.authorize("q2-abc", "pause", challenge))
